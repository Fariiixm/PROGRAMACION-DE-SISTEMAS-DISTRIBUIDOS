...
void saveImage (SDL_Renderer* renderer, char* archivo, int screenWidth, int screenHeight){

	const Uint32 format = SDL_PIXELFORMAT_RGB24;

		SDL_Surface *surface = SDL_CreateRGBSurface(0, screenWidth, screenHeight, 32, 0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000);		
		SDL_RenderReadPixels(renderer, NULL, format, surface->pixels, surface->pitch);
		SDL_LockSurface (surface);
		SDL_SaveBMP(surface, archivo);		
